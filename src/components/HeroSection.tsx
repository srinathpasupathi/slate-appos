...
const HeroSection = () => {
  return (
    <section className="w-full max-w-[1400px] mx-auto px-6 lg:px-10 pt-12 pb-8">
      {/* Tagline */}
      <div className="text-center mb-10">
        <h1 className="text-4xl md:text-5xl lg:text-[3.25rem] leading-tight font-medium text-foreground mb-5">
          Your life's work,<br />
