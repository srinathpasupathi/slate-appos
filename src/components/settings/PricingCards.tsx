...
const plans = [
  {
    ...
    features: [
      "AI app generation",
      "$5 monthly AI credits (up to $1/day)",
  ...
  },
  {
    ...
    popular: true,
    price: 15,
    breakdown: "$10 AI Credits + $5 Cloud Usage",
    ...
    features: [
      ...
      "Role-based access",
      "Included cloud usage credits capacity",
    ],
  },
  {
    name: "Pro",
    ...
    popular: false,
    price: 30,
    breakdown: "$25 AI Credits + $5 Cloud Usage",
    header: "Everything in Builder, plus:",
    features: [
      "High monthly AI credits",
      ...
      "Higher cloud usage credits capacity",
      "Priority support",
    ],
  },
];
